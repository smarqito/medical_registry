...
def generate_IdadeGen(jogadores, inde):
    ...
    # Ref Masculino < 35
    generate_Index(distPorIdade["Menos35"]["M"], jogadores, "www/idade/menos35Masc.html")
    ...
    # Ref Feminino < 35
    generate_Index(distPorIdade["Menos35"]["F"], jogadores, "www/idade/menos35fem.html")
